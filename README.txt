...
* Чтобы включить столкновения надо в классе BallsForm в методе OnPaint раскомментить CheckCollisions(i, ball); (лучше уменьшить колво шаров (все настройки в классе BallsForm) и убрать гравитацию в классе Ball)
* При нажатии левой кнопки мышкой меняется ветор направления от Шарика до Курсора
* При удержании правой кнопки мыши добавляются шары
* Чтобы отключить рисование радуса притяжения нужно закомментить метод DrawRadiusBall(g) в классе BallsForm в методе OnPaint
